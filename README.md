...
14 test scenarios, 45 assertions. Covers spaces in names, malformed JSON, resumable copies, ambiguous matches, path traversal, subpath replacement, and more. No side effects on the real system.
...
| `test-migrate.sh` | Test suite (14 scenarios, 45 assertions) |
